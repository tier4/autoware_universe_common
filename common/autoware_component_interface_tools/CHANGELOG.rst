...
* fix: fix ticket links in CHANGELOG.rst (`#9588 <https://github.com/autowarefoundation/autoware_universe/issues/9588>`_)
* fix: fix missing namespaces in C++ code (`#9477 <https://github.com/autowarefoundation/autoware_universe/issues/9477>`_)
* 0.39.0
* update changelog
...
-------------------
* unify package.xml version to 0.37.0
* refactor(component_interface_tools): prefix package and namespace with autoware (`#9093 <https://github.com/autowarefoundation/autoware_universe/issues/9093>`_)
* Contributors: Esteve Fernandez, Yutaka Kondo
