## TIER IV universe / split mirror (common)

This repository split mirrors the common subtrees of several upstream repositories, used for TIER IV release workflows.
...
| Branch | Contents |
| --- | --- |
| `awf-latest/universe` | `autowarefoundation/autoware_universe:main`, `common/` |
| `awf-latest/core` | `autowarefoundation/autoware_core:main`, `common/`, `testing/` |
